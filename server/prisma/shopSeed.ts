...
const shopItems = [
  ...
  { name: 'Fish Oil', description: '+1 permanent mobility', category: 'supplements', cost: 25, icon: 'FISH+1', type: 'stat_boost', effectValue: 1, statType: 'mobility' },
  ...
  { name: 'Omega-3 Complex', description: '+2 permanent mobility', category: 'supplements', cost: 45, icon: 'OMEGA+2', type: 'stat_boost', effectValue: 2, statType: 'mobility' },
  ...
  { name: 'Mobility Complex', description: '+3 permanent mobility', category: 'supplements', cost: 75, icon: 'MOB+3', type: 'stat_boost', effectValue: 3, statType: 'mobility' },
  ...
  { name: 'Supreme Mobility', description: '+4 permanent mobility', category: 'supplements', cost: 120, icon: 'SUP+4', type: 'stat_boost', effectValue: 4, statType: 'mobility' },
  ...
  { name: 'Mythical Mobility', description: '+5 permanent mobility', category: 'supplements', cost: 200, icon: 'MYTH+5', type: 'stat_boost', effectValue: 5, statType: 'mobility' },
  ...
  { name: 'Creatine Loading', description: 'Permanently increase max energy by 15', category: 'special_items', cost: 200, icon: 'CREATINE', type: 'permanent_energy', effectValue: 15, statType: null },
