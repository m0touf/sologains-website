...
const adventures = [
  ...
  { name: "Everest Base Camp", description: "Trekking to Mount Everest base camp", difficulty: "legendary", energyCost: 70, xpReward: 120, statReward: { strength: 3, stamina: 4, agility: 2 }, cashReward: 100, strengthReq: 50, staminaReq: 50, durationMinutes: 480 },
  { name: "Ironman World Championship", description: "Competing in the Ironman World Championship", difficulty: "legendary", energyCost: 80, xpReward: 140, statReward: { strength: 2, stamina: 5, agility: 2 }, cashReward: 120, strengthReq: 50, staminaReq: 50, durationMinutes: 480 },
  { name: "World's Strongest Man", description: "Competing in the World's Strongest Man competition", difficulty: "legendary", energyCost: 75, xpReward: 130, statReward: { strength: 5, stamina: 2, agility: 0 }, cashReward: 110, strengthReq: 50, staminaReq: 50, durationMinutes: 360 },
  { name: "Spartan Ultra Beast", description: "Completing the most challenging Spartan race", difficulty: "legendary", energyCost: 78, xpReward: 135, statReward: { strength: 3, stamina: 4, agility: 3 }, cashReward: 115, strengthReq: 50, staminaReq: 50, durationMinutes: 420 },
  ...
  { name: "Olympic Decathlon", description: "Competing in the Olympic decathlon", difficulty: "legendary", energyCost: 80, xpReward: 140, statReward: { strength: 3, stamina: 3, agility: 3 }, cashReward: 120, strengthReq: 50, staminaReq: 50, durationMinutes: 360 },
  { name: "Ultra Trail du Mont-Blanc", description: "Running the legendary ultra-trail race", difficulty: "legendary", energyCost: 82, xpReward: 145, statReward: { strength: 2, stamina: 5, agility: 2 }, cashReward: 125, strengthReq: 50, staminaReq: 50, durationMinutes: 480 },
  { name: "Ninja Warrior Finals", description: "Competing in the Ninja Warrior finals", difficulty: "legendary", energyCost: 70, xpReward: 125, statReward: { strength: 2, stamina: 3, agility: 5 }, cashReward: 100, strengthReq: 50, staminaReq: 50, durationMinutes: 300 },
  { name: "Swimming English Channel", description: "Swimming across the English Channel", difficulty: "legendary", energyCost: 85, xpReward: 150, statReward: { strength: 1, stamina: 5, agility: 2 }, cashReward: 130, strengthReq: 50, staminaReq: 50, durationMinutes: 480 },
  { name: "Death Valley Ultra", description: "Running an ultra-marathon through Death Valley", difficulty: "legendary", energyCost: 90, xpReward: 160, statReward: { strength: 2, stamina: 5, agility: 1 }, cashReward: 140, strengthReq: 50, staminaReq: 50, durationMinutes: 480 },
  { name: "MMA Championship", description: "Fighting in a mixed martial arts championship", difficulty: "legendary", energyCost: 75, xpReward: 130, statReward: { strength: 3, stamina: 4, agility: 4 }, cashReward: 110, strengthReq: 50, staminaReq: 50, durationMinutes: 360 }
];
