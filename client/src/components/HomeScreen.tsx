    ...
    <div className="flex-1 relative overflow-hidden">
      ...
      <div className="relative z-10 h-full flex">
        ...
        <div className="w-3/5 flex flex-col items-center justify-center p-6">
          ...
          <div className="bg-amber-100/90 backdrop-blur-sm p-2 ring-2 ring-black shadow-lg max-w-xs w-full rounded-lg mb-3" style={{ imageRendering: 'pixelated' }}>
            <div className="text-center">
              <div className="text-gray-700 font-black text-xs" style={{ fontFamily: 'monospace', textShadow: '1px 1px 0px #fff' }}>CURRENT DATE</div>
              <div className="text-amber-600 font-black text-sm" style={{ fontFamily: 'monospace', textShadow: '1px 1px 0px #fff' }}>
          ...
          {/* Character Stats */}
          <div className="bg-amber-50/95 backdrop-blur-sm p-4 ring-3 ring-black shadow-lg max-w-sm w-full rounded-lg" style={{ imageRendering: 'pixelated' }}>
            <h2 className="text-lg font-black text-gray-800 mb-4 text-center" style={{ fontFamily: 'monospace', textShadow: '1px 1px 0px #fff' }}>YOUR CHARACTER</h2>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-gray-600 font-bold text-sm" style={{ fontFamily: 'monospace' }}>ENERGY</span>
              ...
              <div className="text-center">
                <div className="text-xs font-bold text-gray-600 mb-1" style={{ fontFamily: 'monospace' }}>
                  NEXT ENERGY IN
                </div>
              ...
              <div className="flex justify-between items-center">
                <span className="text-gray-600 font-bold text-sm" style={{ fontFamily: 'monospace' }}>CASH</span>
                <span className="text-green-600 font-black text-sm" style={{ fontFamily: 'monospace', textShadow: '1px 1px 0px #000' }}>${cash}</span>
              </div>
              
              <div className="flex justify-between items-center">
                <span className="text-gray-600 font-bold text-sm" style={{ fontFamily: 'monospace' }}>PROFICIENCY POINTS</span>
